...
int main (int argc, char *argv[])
{
    ...
    gtk_widget_set_size_request(button, 100, 30); // Ajusta el tamaño del botón
    gtk_widget_set_halign(button, GTK_ALIGN_CENTER); // Alinea el botón al centro horizontalmente
    gtk_widget_set_valign(button, GTK_ALIGN_CENTER); // Alinea el botón al centro verticalmente
